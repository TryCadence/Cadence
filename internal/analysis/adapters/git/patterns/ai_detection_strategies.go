...
func (s *DispersionStrategy) Name() string        { return "file_dispersion_analysis" }
func (s *DispersionStrategy) Category() string    { return "structural" }
func (s *DispersionStrategy) Confidence() float64 { return 0.5 }
func (s *DispersionStrategy) Description() string {
	return "Detects too many files changed in a single commit"
}
...
func (s *RatioStrategy) Name() string        { return "ratio_analysis" }
func (s *RatioStrategy) Category() string    { return "statistical" }
func (s *RatioStrategy) Confidence() float64 { return 0.6 }
func (s *RatioStrategy) Description() string {
	return "Detects skewed addition/deletion ratios indicating generated code"
}
...
func (s *PrecisionStrategy) Name() string        { return "precision_analysis" }
func (s *PrecisionStrategy) Category() string    { return "statistical" }
func (s *PrecisionStrategy) Confidence() float64 { return 0.7 }
func (s *PrecisionStrategy) Description() string {
	return "Detects suspiciously precise and balanced code changes"
}
