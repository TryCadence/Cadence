...
func (s *StatisticalAnomalyStrategy) Name() string        { return "StatisticalAnomaly" }
func (s *StatisticalAnomalyStrategy) Category() string    { return "statistical" }
func (s *StatisticalAnomalyStrategy) Confidence() float64 { return 0.8 }
func (s *StatisticalAnomalyStrategy) Description() string {
	return "Detects statistical deviations from repository baseline"
}
...
func (s *TimingAnomalyStrategy) Name() string        { return "TimingAnomaly" }
func (s *TimingAnomalyStrategy) Category() string    { return "behavioral" }
func (s *TimingAnomalyStrategy) Confidence() float64 { return 0.7 }
func (s *TimingAnomalyStrategy) Description() string {
	return "Detects unusual timing patterns between commits"
}
