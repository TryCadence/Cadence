...
func (s *ExcessiveStructureStrategy) Name() string        { return "excessive_structure" }
func (s *ExcessiveStructureStrategy) Category() string    { return "structural" }
func (s *ExcessiveStructureStrategy) Confidence() float64 { return 0.6 }
func (s *ExcessiveStructureStrategy) Description() string {
	return "Detects over-structured content with excessive lists and headings"
}
...
func (s *PerfectGrammarStrategy) Name() string        { return "perfect_grammar" }
func (s *PerfectGrammarStrategy) Category() string    { return "linguistic" }
func (s *PerfectGrammarStrategy) Confidence() float64 { return 0.5 }
func (s *PerfectGrammarStrategy) Description() string {
	return "Detects suspiciously consistent sentence lengths"
}
...
func (s *BoilerplateTextStrategy) Name() string        { return "boilerplate_text" }
func (s *BoilerplateTextStrategy) Category() string    { return "pattern" }
func (s *BoilerplateTextStrategy) Confidence() float64 { return 0.7 }
func (s *BoilerplateTextStrategy) Description() string {
	return "Detects common boilerplate and filler phrases"
}
...
func (s *RepetitivePatternsStrategy) Name() string        { return "repetitive_patterns" }
func (s *RepetitivePatternsStrategy) Category() string    { return "pattern" }
func (s *RepetitivePatternsStrategy) Confidence() float64 { return 0.7 }
func (s *RepetitivePatternsStrategy) Description() string {
	return "Detects repetitive sentence structures and patterns"
}
...
func (s *MissingNuanceStrategy) Name() string        { return "missing_nuance" }
func (s *MissingNuanceStrategy) Category() string    { return "linguistic" }
func (s *MissingNuanceStrategy) Confidence() float64 { return 0.6 }
func (s *MissingNuanceStrategy) Description() string {
	return "Detects excessive absolute terms lacking nuance"
}
...
func (s *ExcessiveTransitionsStrategy) Name() string        { return "excessive_transitions" }
func (s *ExcessiveTransitionsStrategy) Category() string    { return "linguistic" }
func (s *ExcessiveTransitionsStrategy) Confidence() float64 { return 0.7 }
func (s *ExcessiveTransitionsStrategy) Description() string {
	return "Detects overuse of transition words and connectors"
}
...
func (s *UniformSentenceLengthStrategy) Name() string        { return "uniform_sentence_length" }
func (s *UniformSentenceLengthStrategy) Category() string    { return "statistical" }
func (s *UniformSentenceLengthStrategy) Confidence() float64 { return 0.6 }
func (s *UniformSentenceLengthStrategy) Description() string {
	return "Detects unnaturally uniform sentence lengths"
}
...
func (s *AIVocabularyStrategy) Name() string        { return "ai_vocabulary" }
func (s *AIVocabularyStrategy) Category() string    { return "linguistic" }
func (s *AIVocabularyStrategy) Confidence() float64 { return 0.8 }
func (s *AIVocabularyStrategy) Description() string {
	return "Detects AI-characteristic vocabulary and word choices"
}
